...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        QuestionE k = new QuestionE("Какая сегодня погода?", "Подскажите пожалуйста какая сегодня будет погода на камсаке");
        repository.save(k);
        repository.save(new QuestionE("Какой сегодня день недели", "Какой сегодня день недели совсем вылетает из головы"));
        repository.save(new QuestionE("Подскажите хороший сайт с торрент трекерами", "Срочно подскажите хороший сайт с трекерами"));
        repository.save(new QuestionE("Не прогружаются картинки в вк", "У меня созрела неприятная проблема.Я хотел отправить пикчу под постом в ВК но заметил что нужной мне пикчи нету. Прошу заметить, что в общей сложности на телефоне у меня 1059 фотографии, из них 748 скачаны с ВК, но ВКонтакте не показывает и половины фотографий. На фотографии показаны только 2 фотки хотя, напомню, у меня их 748."));
        repository.save(new QuestionE("Сброс пароля с телефона explay n1", "\"Забыл пароль, особо важного там нет. Открыл типо заводское меню с помощью комбинаций клавиш Питание + Кнопка громкости. Что дальше делать не знаю. Помогите!"));
